...
const String cancelText = 'Очистить';
const String viewButtonText = "ПОКАЗАТЬ";
const String goButtonText = "ПОСТРОИТЬ МАРШРУТ";
const String plannedButtonText = "Запланировать";
const String distanceText = "Расстояние";
const String darkModeSwitcherText = "Темная тема";
const String tutorialViewText = "Смотреть туториал";
const String wantToVisitTitle = "Хочу посетить";
